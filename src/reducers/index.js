...
export default combineReducers({ userInfo, albums, musicList, music, control, progress, audio, lyricsUpdate, rankList, spin, hotList, resultList, favoriteMusic, volumeObj });